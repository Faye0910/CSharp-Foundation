    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    MessageBox.Show(score[i]+"成績錯誤");
                    score[i] = 0;
                    textBox1.Text = score[0].ToString();
                    textBox2.Text = score[1].ToString();
                    textBox3.Text = score[2].ToString();
                    textBox4.Text = score[3].ToString();
                    textBox5.Text = score[4].ToString();
                }
           ...
           int c;
            ...
            for(int i=0;i<score.Length-1;i++)
            {
                for (int j = i + 1; j < score.Length; j++)
                {
                    ...
                    textBox7.AppendText(score[x].ToString() + "\n");
                }
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            for(int i=0;i<6;i++)
            {
                textBox6.AppendText(a[i].ToString()+"\n");
            }
        }
    }
}
